...
const testDBName = 'audit_authz_insert';

auditTest('authzInsert', function(m) {
    ...
    assert.eq(0,
              ...
              "FAILED, insert operation has been found in the audit log: " +
                  tojson(auditColl.find().toArray()));
}, {auth: ""});
