...
function test_sasl_mechanisms_include_oidc(clusterClass) {
...
test_sasl_mechanisms_include_oidc(StandaloneMongod);
test_sasl_mechanisms_include_oidc(ShardedCluster);
