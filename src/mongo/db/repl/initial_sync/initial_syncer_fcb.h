...
private:
    ...
    // InitMode passed to catalog::initializeCollectionCatalog when reinitializing the collection
    // catalog after switching the storage location in _switchStorageLocation.
