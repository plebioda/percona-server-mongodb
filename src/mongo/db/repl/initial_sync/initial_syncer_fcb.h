...
private:
    ...
    // InitMode used when re-initializing the collection catalog after switching the storage
    // location (the storage engine is reinitialized in place at a new dbpath).
